...
class in_invoicing(models.Model):
    ...
    state = fields.Selection(selection_add=[('credit_approval', 'Ask for Credit Approval'), ('approved', 'Credit Approved')])
...
class SaleOrder(models.Model):
    ...
    def _check_status(self):
        for i in self:
            ...
            if search_invoice.payment_state in ['paid','partial'] or search_invoice.check_status in ['approved']:
